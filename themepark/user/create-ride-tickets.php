    ...
    if(isset($_POST['submit']))
  {
    ...
    $kidtprice=$_POST['kidtprice'];
     $_SESSION['ticketno']=$bookno;
       ...
       $query=mysqli_query($con, "insert into  tblridetickets(TIcketNumber,RideType,Name,Gender,Address,NoOfMale,MaleTicketPrice,NoOfFemale,FemaleTicketPrice,NoOfKids,NoOfKidsForTicket,KidsTicketPrice,UserID) value('$bookno','$rtype','$fname','$gender','$address','$noofmale','$mtprice','$nooffemale','$ftprice','$noofkids','$noofkidticket','$kidtprice','$uid')");
    if ($query) {
