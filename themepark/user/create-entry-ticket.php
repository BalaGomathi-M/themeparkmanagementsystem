    ...
    if(isset($_POST['submit']))
  {
    ...
    $kidtprice=$_POST['kidtprice'];
     $_SESSION['ticketno']=$bookno;
       ...
       $query=mysqli_query($con, "insert into  tblentrytickets(TIcketNumber,Name,Gender,Address,NoOfMale,MaleTicketPrice,NoOfFemale,FemaleTicketPrice,NoOfKids,NoOfKidsForTicket,KidsTicketPrice,UserID) value('$bookno','$fname','$gender','$address','$noofmale','$mtprice','$nooffemale','$ftprice','$noofkids','$noofkidticket','$kidtprice','$uid')");
    if ($query) {
...
?>         
         <table class="table table-bordered">
          ...
          <tr>
            <th>Kids above 5yrs ticket complulsory</th>
