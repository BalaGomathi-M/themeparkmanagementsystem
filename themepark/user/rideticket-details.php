...
<div id="wrapper">
  ...
  <span style="float:left" ><i class="fa fa-print fa-2x" aria-hidden="true" OnClick="CallPrint(this.value)" style="cursor:pointer" title="Print the Report"></i></span> 
    <h1 align="center"><b>Adhisayam Theme Park</b></h2>
	<h2 align="center"><b>Madurai</b>
	<h3 align="center"><b>Ride Ticket</b><h3>
    <h3 align="center"><?php echo $_SESSION['ticketno'];?><b> Details</b></h3>
