...
if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['email'];
        ...
        $query=mysqli_query($con,"select ID from tbluser where  Email='$email' and Mobile='$contactno' ");
...
<body id="login">
  ...
  <div class="app-cam">
    ...
    <input type="text" name="email" class="text" placeholder="Email" required="true">
		...
		<ul class="new">
			<li class="new_left"><p><a href="userlogin.php">Allready have an account!!</a></p></li>
			</li>
