        ...
        <div class="graphs">
     	<div class="col_3">
        	<div class="col-md-4 widget widget1">
              ...
              <?php
$uid=$_SESSION['uid'];			  
			  $query1=mysqli_query($con,"Select * from  tblentrytickets where UserId='$uid'");
...
?>
        	...
        	<div class="col-md-4 widget widget1">
        		<div class="r3_counter_box">
              <?php $query=mysqli_query($con,"Select * from  tblridetickets where RideType='Normal Ride where UserId='$uid''");
...
?>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
              <?php $query3=mysqli_query($con,"Select * from  tblridetickets where RideType='water Ride' where UserId='$uid'");
