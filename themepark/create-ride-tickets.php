...
if (strlen($_SESSION['tpmsaid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
   ...
   echo "insert into  tblridetickets(TIcketNumber,RideType,Name,Gender,Address,NoOfMale,MaleTicketPrice,NoOfFemale,FemaleTicketPrice,NoOfKids,NoOfKidsForTicket,KidsTicketPrice) value('$bookno','$rtype','$fname','$gender','$address','$noofmale','$mtprice','$nooffemale','$ftprice','$noofkids','$noofkidticket','$kidtprice')";
   exit();
